package com.example.kms.configuration;
...
public class AWSConfig {
	...
	@Primary
	 public KmsClient KMSExample() {
        ...
        kmsClient = KmsClient.builder().credentialsProvider(StaticCredentialsProvider.create(awsCreds)).region(Region.AP_SOUTHEAST_2).build();
        return kmsClient;
    }
